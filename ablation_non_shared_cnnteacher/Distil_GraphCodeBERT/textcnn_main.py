        ...
        for step, batch in enumerate(bar):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % args.save_steps == 0:
                    results = evaluate(args, model, tokenizer, eval_dataset, ema, eval_when_training=True)    
...
def evaluate(args, model, tokenizer, eval_dataset, ema, eval_when_training=False):
    #build dataloader
    ...
    for batch in eval_dataloader:
        ...
        with torch.no_grad():
            with ema.average_parameters():
                prob = model(source_ids=source_ids, position_idx=position_idx, attn_mask=attn_mask)
...
def main():
    ...
    if args.do_test:
        ...
        test_acc = test(args, model, tokenizer, test_dataset, best_threshold=0.5)
    return test_acc
