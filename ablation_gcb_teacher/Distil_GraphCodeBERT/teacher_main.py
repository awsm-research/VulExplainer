...
def main():
    ...
    model = TeacherModel(shared_model=gcb_model, tokenizer=tokenizer, num_labels=len(cwe_label_map), args=args)
    ...
    if args.do_test:
        ...
        ##analyze_predictions(y_trues, y_preds, cwe_label_map, args=args)
    return results
